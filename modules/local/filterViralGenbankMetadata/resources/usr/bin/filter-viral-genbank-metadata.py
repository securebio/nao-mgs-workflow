...
def main() -> None:
    ...
    parser.add_argument(
        "meta_db",
        help="Path to metadata table from ncbi-genome-download.",
    )
    parser.add_argument(
        "virus_db",
        help="Path to TSV of virus taxa, annotated with infection status.",
    )
    parser.add_argument(
        "host_taxa",
        help="Space-separated list of host taxon names to filter to.",
    )
    parser.add_argument("output_db", help="Output path to filtered metadata TSV.")
    parser.add_argument(
        "output_accessions",
        help="Output path to filtered list of genome accessions.",
    )
    parser.add_argument(
        "output_paths",
        help="Output path to filtered list of genome filepaths.",
    )
