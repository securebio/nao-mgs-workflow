...
class TestSortTsv:
    ...
    def test_missing_sort_field_raises_error(self, tsv_factory: Any) -> None:
    ...
    def test_sort_unsorted_plaintext(self, tsv_factory: Any) -> None:
    ...
    def test_sort_unsorted_gzipped(self, tsv_factory: Any) -> None:
