...
# Channel operators that gather many items into one emission. `collect` is matched only in
# its parenthesised channel form, since Groovy's list `collect { ... }` maps a list instead.
GATHER = re.compile(
