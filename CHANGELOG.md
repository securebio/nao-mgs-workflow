...
- Add six host-infection overrides to `ref/host-infection-overrides.json`, restoring the infection statuses these taxa had in the 20260702 index: Gyrovirus homsa4, Hudisavirus jaqis, Camdisavirus lingis, Giant panda anellovirus, Rotavirus kappagastroenteritidis (Rotavirus K) and Circoviridae TM-6c. Each lost its statuses with no clear cause other than a taxonomic reorganisation breaking status propagation from Virus-Host DB, and there is no confirmatory evidence justifying a demotion. (#1025)
