...
- Add six host-infection overrides to `ref/host-infection-overrides.json`, restoring the infection statuses these taxa had in the 20260702 index: Gyrovirus homsa4, Hudisavirus jaqis, Camdisavirus lingis, Giant panda anellovirus, Rotavirus kappagastroenteritidis (Rotavirus K) and Circoviridae TM-6c. Each was demoted despite close relatives being established vertebrate-infecting viruses and no evidence that it does not infect vertebrates.
