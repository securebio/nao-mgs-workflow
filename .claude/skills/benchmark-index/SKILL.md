...
| §3.2 Losses | Top-5 species per loss category + summary of species-dropped-to-zero (with redistribution / true-loss split). | Prose discussion: which categories matter for surveillance, which are routine, any species that warrant scientist review. |
